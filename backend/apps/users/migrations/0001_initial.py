    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('PASTOR', 'Pastor/Elder'), ('RECEPTIONIST', 'Receptionist'), ('SECURITY', 'Security Personnel'), ('FOLLOWUP', 'Follow-up Team'), ('MEDIA', 'Media Team'), ('READONLY', 'Read-only User')], default='READONLY', max_length=20)),
